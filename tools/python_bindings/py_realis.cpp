...
#include "mingw_threading_shim.h"
#include <mutex>
...
PYBIND11_MODULE(py_realis, m) {
  ...
  py::class_<realis::RigidBody>(m, "RigidBody")
      ...
      .def_readwrite("velocity", &realis::RigidBody::velocity)
      .def_readwrite("mass", &realis::RigidBody::mass)
      .def_readwrite("restitution", &realis::RigidBody::restitution)
      .def_readwrite("friction", &realis::RigidBody::friction);
}
